...
du -sh /home/*/*.zip|sort -h

printf "## Large PHP-FPM error logs\n"
ls -lhGS /home/*/logs/*php.error.log|tac|tail -n20|awk '{print $4" "$8}'|column -t

printf "## Failed uploads for cPanel File Manager\n"
du -hs /home/*/tmp/Cpanel_Form_file.upload*|egrep "([0-9]{1}G|[0-9]{2}M)[[:space:]]" |sort -h

# todo: zi3BKqcc zi?????? regex for failed zip files

printf "## Old/failed ImageMagick temp files\n"
du -hs /home/*/tmp/img??????|egrep "([0-9]{1}G|[0-9]{1}M)[[:space:]]" |sort -h

printf "## Old Roundcube mail attachment temp files\n"
du -hs /home/*/tmp/rcmAttmnt*|egrep "([0-9]{1}G|[0-9]{2}M)[[:space:]]" |sort -h

printf "## Old Horde Mail drafts (more than 10 MB in size)\n"
du -hs /home/*/tmp/horde/.horde/imp/compose/*-*-*|egrep "([0-9]{1}G|[0-9]{2}M)[[:space:]]" |sort -h

printf "## Horde ImageMagick temp files\n"
du -hs /home/*/tmp/horde/img??????|egrep "([0-9]{1}G|[0-9]{1}M)[[:space:]]" |sort -h
...
du -sh /home/*/mail/*.*/*/.Trash /home/*/mail/*/*/.spam/ /home/*/mail/*.*/*/.Junk |egrep "([0-9]{1}G|[0-9]{2}M)[[:space:]]"
